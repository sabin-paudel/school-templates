...
export const metadata: Metadata = {
  title: "About | Aatreya Academy",
  description:
    "Learn about Aatreya Academy's purpose, values and educational approach.",
};
  ...
  return (
    <>
      ...
      <section className="section bg-paper">
        <Reveal className="section-shell grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-24">
          <div>
            ...
            <p className="mt-7 text-lg leading-8 text-muted">
              Horizon Academy began in 2002 with a clear idea: children do their
              best work when expectations are high, relationships are strong and
      ...
      <section className="section bg-cream">
        <div className="section-shell">
          <p className="eyebrow text-gold-dark">What guides us</p>
          <h2 className="section-title mt-5">Values made visible every day.</h2>
          <div className="mt-12 grid gap-px bg-line md:grid-cols-3">
            {[
              [
                Lightbulb,
                "Curiosity",
                "We ask better questions, test ideas and treat mistakes as part of meaningful learning.",
              ],
              [
                HeartHandshake,
                "Care",
                "We listen closely, act kindly and make sure every member of our community belongs.",
              ],
              [
                Scale,
                "Integrity",
              ...
              const ValueIcon = Icon as typeof Lightbulb;
              return (
                <article key={title as string} className="bg-paper p-8 lg:p-10">
                  <ValueIcon className="text-gold-dark" size={28} />
                  <h3 className="mt-8 font-serif text-3xl text-forest">
                    {title as string}
                  </h3>
                  <p className="mt-4 leading-7 text-muted">{text as string}</p>
                </article>
              );
            })}
          </div>
          <Link href="/contact" className="button button-dark mt-12">
            Visit our campus <ArrowRight size={17} />
          </Link>
        </div>
      </section>
    </>
